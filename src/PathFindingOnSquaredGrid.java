...
public class PathFindingOnSquaredGrid {
 ...
 // does the system percolate vertically in a direct way?
    ...
    public static void main(String[] args) {
        ...
        int gridSize =10;
    	boolean[][] randomlyGenMatrix = random(gridSize, 0.7);
     ...
     // THIS IS AN EXAMPLE ONLY ON HOW TO USE THE JAVA INTERNAL WATCH
        ...
        //Getting the path to the end point
        DijikstraAlgo da = new DijikstraAlgo();
          ArrayList<Vertex> path = da.distance(randomlyGenMatrix, Ai, Aj, Bi, Bj,type);
       ...
       // StdOut.println("Elapsed time = " + timerFlow.elapsedTime());
          ...
          if(da.pathFound){
            StdOut.println("Distance " + da.grid[Bi][Bj].distance);
          }
        for(int i =0;i< path.size()-1;i++){
            StdDraw.filledSquare(path.get(i).j, gridSize - path.get(i).i-1 ,.5);
        }
        StdOut.println("Elapsed time = " + timerFlow.elapsedTime());
